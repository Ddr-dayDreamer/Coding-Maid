...
`,
  ...
  var AppState = class {
    ...
    get approvalConfig() {
      return get2(__privateGet(this, _approvalConfig));
    }
    set approvalConfig(value) {
      set(__privateGet(this, _approvalConfig), value, true);
    }
    get attachedFiles() {
  ...
  // resources/webview/components/PlanDisplay.svelte
  var root5 = from_html(`<div><span class="task-icon svelte-uhf122"> </span> <span class="task-text svelte-uhf122"> </span></div>`);
  var root_14 = from_html(`<div class="task-separator svelte-uhf122"></div>`);
  var root_23 = from_html(`<div class="task-heading-2 svelte-uhf122"> </div>`);
  var root_33 = from_html(`<div class="task-heading-1 svelte-uhf122"> </div>`);
  var root_43 = from_html(`<div class="task-text svelte-uhf122"> </div>`);
  var root_53 = from_html(`<div class="plan-display svelte-uhf122"><div class="plan-header svelte-uhf122">\u{1F4CB} \u5F53\u524D\u8BA1\u5212</div> <div class="plan-body svelte-uhf122"></div></div>`);
  function PlanDisplay($$anchor, $$props) {
    push($$props, true);
    "use strict";
    function parsePlan(text2) {
      try {
    ...
    function getTaskItems(markdown) {
      ...
      for (const line of lines) {
        ...
        if (taskMatch) {
          items2.push({ prefix: taskMatch[2], text: taskMatch[3] });
          continue;
        }
        const listMatch = line.match(/^(\s*[-*]\s+)(.*)$/);
        if (listMatch) {
          items2.push({ prefix: "", text: line });
          continue;
        }
    ...
    function getStatusClass(prefix) {
      switch (prefix) {
        case "x":
          return "task-done";
        case ">":
    ...
    const planData = user_derived(() => parsePlan($$props.content));
    const taskItems = user_derived(() => get2(planData) ? getTaskItems(get2(planData).metadata.plan) : []);
    const heading = user_derived(() => get2(planData)?.metadata?.plan?.split("\n")[0] ?? "");
    ...
    var node = first_child(fragment);
    {
      var consequent_4 = ($$anchor2) => {
        var div = root_53();
        var div_1 = sibling(child(div), 2);
        each(div_1, 21, () => get2(taskItems), index, ($$anchor3, item) => {
          ...
          var node_1 = first_child(fragment_1);
          {
            var consequent = ($$anchor4) => {
              ...
              template_effect(
                ($0, $1) => {
                  set_class(div_2, 1, `task-item ${$0 ?? ""}`, "svelte-uhf122");
                  set_text(text_1, $1);
                  set_text(text_2, get2(item).text);
                },
                [
                  () => getStatusClass(get2(item).prefix),
                  () => getStatusIcon(get2(item).prefix)
                ]
              );
            ...
            var consequent_2 = ($$anchor4) => {
              ...
              reset(div_4);
              template_effect(($0) => set_text(text_3, $0), [() => get2(item).text.replace(/^##+\s*/, "")]);
              append($$anchor4, div_4);
            };
            var d = user_derived(() => get2(item).text.startsWith("##"));
            var consequent_3 = ($$anchor4) => {
              var div_5 = root_33();
              var text_4 = child(div_5, true);
              reset(div_5);
              template_effect(($0) => set_text(text_4, $0), [() => get2(item).text.replace(/^#\s*/, "")]);
              append($$anchor4, div_5);
            };
            var d_1 = user_derived(() => get2(item).text.startsWith("# "));
            var alternate = ($$anchor4) => {
              var div_6 = root_43();
              var text_5 = child(div_6, true);
              reset(div_6);
              template_effect(() => set_text(text_5, get2(item).text));
              append($$anchor4, div_6);
            };
            if_block(node_1, ($$render) => {
              if (get2(item).prefix !== "") $$render(consequent);
              else if (get2(item).text === "") $$render(consequent_1, 1);
              else if (get2(d)) $$render(consequent_2, 2);
              else if (get2(d_1)) $$render(consequent_3, 3);
              else $$render(alternate, -1);
            });
          }
      ...
      if_block(node, ($$render) => {
        if (get2(planData)) $$render(consequent_4);
      });
    }
  ...
  var root6 = from_html(`<span class="option-desc svelte-1gpypfo"> </span>`);
  ...
  function ToolMessage($$anchor, $$props) {
    ...
    function isSuccessfulUpdatePlan() {
    ...
    var node = child(div_1);
    {
      ...
      var consequent_3 = ($$anchor2) => {
        ...
        each(node_3, 17, getPendingApprovals, index, ($$anchor3, item) => {
          ...
          delegated("click", button_2, () => approveTool(get2(item).toolCallId));
          delegated("click", button_3, () => rejectTool(get2(item).toolCallId));
  ...
  var root7 = from_html(`<div class="bubble-system svelte-12vix06"><div class="bubble-body svelte-12vix06"> </div></div>`);
  var root_16 = from_html(`<div class="empty-state svelte-12vix06"><div class="empty-icon svelte-12vix06">\u{1F4AC}</div> <p class="svelte-12vix06">\u5F00\u59CB\u65B0\u7684\u5BF9\u8BDD</p> <p class="empty-hint svelte-12vix06">\u8F93\u5165\u6D88\u606F\u5E76\u6309 Enter \u53D1\u9001</p></div>`);
  var root_25 = from_html(`<div class="streaming-thinking svelte-12vix06"><span class="thinking-label svelte-12vix06"> </span> <div class="streaming-reasoning svelte-12vix06"> </div></div>`);
  var root_35 = from_html(`<div class="streaming-answer svelte-12vix06"><div class="bubble-content svelte-12vix06"> <span class="cursor svelte-12vix06">\u258A</span></div></div>`);
  var root_45 = from_html(`<div class="bubble-streaming svelte-12vix06"><div class="bubble-avatar svelte-12vix06"></div> <div class="bubble-body svelte-12vix06"><!> <!></div></div>`);
  var root_55 = from_html(`<div class="loading-indicator svelte-12vix06"><div class="spinner svelte-12vix06"></div> <span class="svelte-12vix06">\u7B49\u5F85\u54CD\u5E94\u2026</span></div>`);
  ...
  var root8 = from_html(`<div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u8F93\u5165</span> <span class="svelte-vvns5x"> </span></div> <div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u8F93\u51FA</span> <span class="svelte-vvns5x"> </span></div> <div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u8BF7\u6C42\u6B21\u6570</span> <span class="svelte-vvns5x"> </span></div>`, 1);
  var root_17 = from_html(`<div class="meter-empty svelte-vvns5x">\u6682\u65E0\u7528\u91CF\u6570\u636E</div>`);
  var root_26 = from_html(`<div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u672C\u6B21\u7F13\u5B58</span> <span class="svelte-vvns5x"> </span></div>`);
  var root_36 = from_html(`<div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u7D2F\u8BA1\u7F13\u5B58</span> <span class="svelte-vvns5x"> </span></div>`);
  var root_46 = from_html(`<!> <!>`, 1);
  var root_56 = from_html(`<div class="meter-tooltip svelte-vvns5x" role="tooltip"><div class="meter-tooltip-header svelte-vvns5x"> </div> <div class="meter-row svelte-vvns5x"><span class="svelte-vvns5x">\u4E0A\u4E0B\u6587</span> <span class="svelte-vvns5x"> </span></div> <!> <!></div>`);
  ...
  var root9 = from_html(`<span class="check svelte-afcpaa">\u2713</span>`);
  var root_18 = from_html(`<button><span class="item-name svelte-afcpaa"> </span> <!></button>`);
  var root_27 = from_html(`<div class="empty svelte-afcpaa">\u6682\u65E0\u9884\u8BBE</div>`);
  var root_37 = from_html(`<div class="dropdown svelte-afcpaa"></div>`);
  var root_47 = from_html(`<div class="quick-selector svelte-afcpaa"><button class="badge-btn svelte-afcpaa"> <svg viewBox="0 0 1024 1024" width="10" height="10"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></button> <!></div>`);
  ...
  var root10 = from_html(`<span class="check svelte-hh7eb2">\u2713</span>`);
  var root_19 = from_html(`<button><span class="item-name svelte-hh7eb2"> </span> <!></button>`);
  var root_28 = from_html(`<div class="empty svelte-hh7eb2">\u6682\u65E0\u914D\u7F6E</div>`);
  var root_38 = from_html(`<div class="dropdown svelte-hh7eb2"></div>`);
  var root_48 = from_html(`<div class="quick-selector svelte-hh7eb2"><button class="badge-btn svelte-hh7eb2"> <svg viewBox="0 0 1024 1024" width="10" height="10"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></button> <!></div>`);
  ...
  var root12 = from_svg(`<svg viewBox="0 0 16 16" width="16" height="16"><rect x="3" y="3" width="10" height="10" rx="2" fill="currentColor"></rect></svg>`);
  var root_111 = from_svg(`<svg viewBox="0 0 16 16" width="16" height="16"><path d="M1.5 1.5L14.5 8L1.5 14.5V1.5z" fill="currentColor"></path></svg>`);
  var root_210 = from_html(`<div><div class="input-wrap svelte-z2mbmf"><!> <textarea placeholder="\u8F93\u5165\u6D88\u606F... (Shift+Enter \u6362\u884C\uFF0C\u62D6\u5165\u6587\u4EF6\u6309\u4F4F Shift)" rows="1" class="svelte-z2mbmf"></textarea> <div class="composer-footer svelte-z2mbmf"><div class="footer-left svelte-z2mbmf"><!> <!> <!></div> <div class="footer-right"><button class="send-btn svelte-z2mbmf"><!></button></div></div></div></div>`);
  ...
  function ApprovalPage($$anchor, $$props) {
    push($$props, true);
    const BUILTIN_TOOLS2 = getBuiltinToolIds();
    const TOOL_LABELS = {
      bash: "\u6267\u884C\u547D\u4EE4",
      read: "\u8BFB\u53D6\u6587\u4EF6",
      write: "\u5199\u5165\u6587\u4EF6",
    ...
    async function loadConfig() {
      ...
      try {
        try {
          const config = await api.request("getApprovalConfig");
    ...
    function updateMode(name, mode) {
      const tool = get2(tools).find((t) => t.name === name);
      if (tool) {
        tool.mode = mode;
        set(changed, true);
      }
    ...
    function getModeColor(mode) {
      switch (mode) {
        ...
        case "require":
          return "var(--vscode-charts-orange, #d29922)";
        default:
    ...
    var node = sibling(child(div), 2);
    {
      ...
      var alternate = ($$anchor2) => {
        ...
        each(div_3, 21, () => get2(tools), (tool) => tool.name, ($$anchor3, tool) => {
          ...
          option_1.value = option_1.__value = "require";
          reset(select);
          var select_value;
          init_select(select);
          reset(div_6);
          ...
          template_effect(
            ($0) => {
              set_text(text2, get2(tool).name);
              set_text(text_1, get2(tool).label);
              set_style(div_7, `background: ${$0 ?? ""}`);
              if (select_value !== (select_value = get2(tool).mode)) {
                select.value = (select.__value = get2(tool).mode) ?? "", select_option(select, get2(tool).mode);
              }
            },
            [() => getModeColor(get2(tool).mode)]
          );
          delegated("change", select, (e) => updateMode(get2(tool).name, e.target.value));
          append($$anchor3, div_4);
        });
        reset(div_3);
        var node_1 = sibling(div_3, 2);
        {
          var consequent_1 = ($$anchor3) => {
            ...
            next(2);
            reset(div_8);
            delegated("click", button_2, saveConfig);
            append($$anchor3, div_8);
          };
          if_block(node_1, ($$render) => {
            if (get2(changed)) $$render(consequent_1);
          });
        }
        delegated("click", button, () => setAll("require"));
        delegated("click", button_1, () => setAll("none"));
        append($$anchor2, fragment);
      };
      if_block(node, ($$render) => {
  ...
  function App($$anchor, $$props) {
    ...
    var node_1 = sibling(node, 2);
    {
      ...
      if_block(node_1, ($$render) => {
        ...
        else if (appState.currentTab === "approvals") $$render(consequent_1, 1);
        else if (appState.currentTab === "presets") $$render(consequent_2, 2);
        else if (appState.currentTab === "profiles") $$render(consequent_3, 3);
      });
    }
    var node_2 = sibling(node_1, 2);
    ...
    var node_3 = sibling(node_2, 2);
    {
      ...
      if_block(node_3, ($$render) => {
        if (appState.isDragOver) $$render(consequent_4);
      });
    }
    reset(div);
